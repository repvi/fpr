...
static const char *TAG = "sprout_new";

bool sprout_new_handle_protocol_version(code_version_t version, const esp_now_recv_info_t *esp_now_info, const uint8_t *data, int len)
{
    (void)data;
    (void)len;
